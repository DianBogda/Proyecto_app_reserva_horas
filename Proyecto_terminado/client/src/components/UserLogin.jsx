    ...
    return(
        <div className='wrapper'>
            <header>
                ...
                <h2 className='mensajes user-log'>Gracias por elegirnos</h2>
            </header>   
            <nav className='nav_bar'>
                <Link className='link' to={'/'}>Portada</Link>
            </nav> 
            <div>
                <h3 className='encabezado espejo_encab'>Déjate embellecer e ingresa para reservar alguna hora:</h3>
                <form className='form' onSubmit={loginUser}>
                    ...
                    <div className='nav_bar_btn'>
                        <Button type="submit" className='rrssbtn default'>Ingresa para reservar tu hora</Button>
                    </div>
                </form>
            </div>                
        </div>
