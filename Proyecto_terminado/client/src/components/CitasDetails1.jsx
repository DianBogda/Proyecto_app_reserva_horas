    ...
    return(
        <div className='wrapper'>
            ...
            <header>
                ...
                <h2 className='mensajes ext'>Servicio Extensión de Pestañas</h2>
            </header>   
                        ...
                        reservas.map((reserva, index) => {
                            return(
                                <tr key={index}>
                                    ...
                                    <td className='cuerpo'><Button className='eliminar default' onClick={() => {deleteCita1(reserva._id)}}>Eliminar</Button></td>
                                </tr>
                            )
                        }) : (
                            <tr>
